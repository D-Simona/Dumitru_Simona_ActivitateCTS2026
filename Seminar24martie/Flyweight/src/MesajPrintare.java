...
public class MesajPrintare implements IPrintare{
    ...
    //metoda aceasta reuneste cele 2 zone ale obiectului (zona shared de zona unshared)
    @Override
